...
public class DBHelper {
    ...
    public static void eraseData() throws SQLException {
        ...
        try {
            ...
            rs = conn.prepareStatement("SELECT TABLE_NAME FROM information_schema.tables WHERE TABLE_SCHEMA = 'schooldb'")
                    .executeQuery();
            List<String> tables = mapsToList(rs);
    ...
    private static List<String> mapsToList(ResultSet rs) throws SQLException {
